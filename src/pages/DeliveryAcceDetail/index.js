...
const Description = ({ term, children,}) => (
  ...
  const extraContent = (
      <Row>
          <Col span={12}><Statistic title="状态" value="已验收" /></Col>
          <Col span={12}><Statistic title="总金额" prefix="￥" value={8.8+'万'} /></Col>
      </Row>
  );
  

class DeliveryAcceDetail extends React.Component {

	render() {
        const {location} = this.props;
		return(
            <div className='AcceDetail'>
